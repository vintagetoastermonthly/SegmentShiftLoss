...
#28 Sept 2021 - modify to use ENet B4 instead of resnet50 backbone
"""
ResNet50					ENet B4
...
def getmodel(modelfile,shape=(512,512,3)):
	...
	**Dilated convolution:** With dilated convolution, as we go deeper in the network, we can keep the
	...
	def DeeplabV3Plus(image_size, num_classes):
		...
		#)
		basemodel = keras.applications.EfficientNetB4(
			weights="imagenet", include_top=False, input_tensor=model_input
		)
		...
		x = basemodel.get_layer("block6a_expand_activation").output
		...
		input_b = basemodel.get_layer("block3a_expand_activation").output
